...
plt.savefig("figures/2_spliced.png", dpi=300)
#plt.show()
plt.close()
...
plt.savefig("figures/2_spliced10s.png", dpi=300)
#plt.show()
plt.close()
...
plt.savefig("figures/2_spliced20s.png", dpi=300)
#plt.show()
plt.close()
...
comparison = []
with h5py.File(fr'data/2_noiseless.h5', "r") as f:
	u = f["u"][:]
	x = f["x"][:]
...
with h5py.File(fr'data/sims/data_0.h5', "r") as f:
	...
	plt.legend()
	plt.grid()
	plt.savefig("figures/2_noise_visualization.png", dpi=300)
	#plt.show()
	plt.close()

# Save concatenated data
with h5py.File(f"data/2_concatenated.h5", "w") as f:
...
with h5py.File(f"data/2_concatenated_10s.h5", "w") as f:
...
with h5py.File(f"data/2_concatenated_20s.h5", "w") as f:
